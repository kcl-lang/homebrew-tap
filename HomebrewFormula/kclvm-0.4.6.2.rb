class Kclvm0462 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/kcl-lang/kcl/releases/download/v0.4.6.2/kclvm-v0.4.6.2-darwin-arm64.tar.gz"
      sha256 "fbc1cf817c1ac994bd1ff3ba8b5929da1e7b480f9c871ee21f1cfa61deb29fd3"
    end
    if Hardware::CPU.intel?
      url "https://github.com/kcl-lang/kcl/releases/download/v0.4.6.2/kclvm-v0.4.6.2-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/kcl-lang/kcl/releases/download/v0.4.6.2/kclvm-v0.4.6.2-linux-amd64.tar.gz"
