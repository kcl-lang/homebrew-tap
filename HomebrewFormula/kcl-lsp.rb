class KclLsp < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/kcl-lang/kcl/releases/download/v0.7.0-beta.2/kclvm-v0.7.0-beta.2-darwin-arm64.tar.gz"
      sha256 "51c06fb14b87dc96c80a861986ddfb12e45cd066992f3d05a3aa695f04265589"
    end
    if Hardware::CPU.intel?
      url "https://github.com/kcl-lang/kcl/releases/download/v0.7.0-beta.2/kclvm-v0.7.0-beta.2-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/kcl-lang/kcl/releases/download/v0.7.0-beta.2/kclvm-v0.7.0-beta.2-linux-amd64.tar.gz"
