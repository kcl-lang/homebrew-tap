class Kclvm0463 < Formula
  ...
  def install
      ...
      libexec.install Dir["*"]
      lib.install  Dir["#{libexec}/bin/lib*"]
      bin.install Dir["#{libexec}/bin/*"]
      bin.env_script_all_files libexec/"bin", KCL_PLUGINS_ROOT: "#{libexec}/plugins", KCLVM_LIB_LINK_PATH: "#{libexec}/lib"
  end
end
