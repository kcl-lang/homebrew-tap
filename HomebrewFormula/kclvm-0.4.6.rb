class Kclvm046 < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/kcl-lang/kcl/releases/download/v0.4.6/kclvm-v0.4.6-darwin-arm64.tar.gz"
      sha256 "7c1f14f12bc5a7d547e79e55ddfe9e92bcdfa0194892261d301f680b20d7feb5"
    end
    if Hardware::CPU.intel?
      url "https://github.com/kcl-lang/kcl/releases/download/v0.4.6/kclvm-v0.4.6-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/kcl-lang/kcl/releases/download/v0.4.6/kclvm-v0.4.6-linux-amd64.tar.gz"
